...
<div class="container courses-wrapper">
			<div class="row course-list" data-behavior="endless-scroll">
	...
	<div class="main-wrapper" >
		...
		<a href="course/2508.jsp">
			...
			<div id="course_2498" class="course col-sm-6 col-md-4 col-lg-3 card ">
	<div class="main-wrapper" >
		
		
		<a href="course/2498.jsp">
	        <div class="image-wrapper" style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/yd2lm30wdbiunrnligm6');">
			...
			<div id="course_2500" class="course col-sm-6 col-md-4 col-lg-3 card ">
	<div class="main-wrapper" >
		
		
		<a href="course/2500.jsp">
	        <div class="image-wrapper" style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/nvhovgg3zrnugxnhz3ue');">
			...
			<div id="course_2564" class="course col-sm-6 col-md-4 col-lg-3 card ">
	<div class="main-wrapper" >
		
		
		<a href="course/2564.jsp">
	        <div class="image-wrapper" style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/jbbxg3r21badwkqgnvly');">
			...
			<div class="info-wrapper">
				<div class="author-wrapper">
					...
					<div class="master-name">카페인기타 </div>
	            	<div class="course-duration">2 개의 강의</div>
					<h2> [+TAB] 볼빨간사춘기 &amp; 스무살 - 남이 될 수 있을까</h2>
					<div class="summary">
						<span> Bolbbalgan4, 20 Years Of Age -  We Loved</span>
						<span class="ellipsis"></span>
					</div>
					<div class="rank-seat">
				      					      						      			<span class="no-schedule">상시 오픈</span>
			...
			<div id="course_2521" class="course col-sm-6 col-md-4 col-lg-3 card ">
	<div class="main-wrapper" >
		
		
		<a href="course/2521.jsp">
	        <div class="image-wrapper" style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/pzpbzv4nviobfy9yrhsc');">
			...
			<div class="info-wrapper">
				<div class="author-wrapper">
					...
					<div class="master-name">카페인기타 </div>
	            	<div class="course-duration">2 개의 강의</div>
					<h2>[+TAB] 씨스타 - LONELY</h2>
					<div class="summary">
						<span>SISTAR - Lonely</span>
						<span class="ellipsis"></span>
					</div>
					<div class="rank-seat">
				      					      						      			<span class="no-schedule">상시 오픈</span>
			...
			<div id="course_2535" class="course col-sm-6 col-md-4 col-lg-3 card ">
	<div class="main-wrapper" >
		
		
		<a href="course/2535.jsp">
	        <div class="image-wrapper" style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/lq1tjsfpdrjhvciz33no');">
			...
			<div id="course_2515" class="course col-sm-6 col-md-4 col-lg-3 card ">
	<div class="main-wrapper" >
		
		
		<a href="course/2515.jsp">
	        <div class="image-wrapper" style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/qx2bla2kva106hdauaph');">
			...
			<div class="info-wrapper">
				<div class="author-wrapper">
					...
					<div class="master-name">카페인기타 </div>
	            	<div class="course-duration">2 개의 강의</div>
					<h2>[+TAB] 아이유 - Palette</h2>
					<div class="summary">
						<span>IU - Palette (팔레트) Feat. G-DRAGON</span>
						<span class="ellipsis"></span>
					</div>
					<div class="rank-seat">
				      					      						      			<span class="no-schedule">상시 오픈</span>
			...
			<div id="course_2520" class="course col-sm-6 col-md-4 col-lg-3 card ">
	<div class="main-wrapper" >
		
		
		<a href="course/2520.jsp">
	        <div class="image-wrapper" style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/w7edrcouz6a72ndjiaiz');">
			...
			<div class="info-wrapper">
				<div class="author-wrapper">
					...
					<h2>[+TAB] 아이유 - 밤편지</h2>
					<div class="summary">
						<span>IU - Through the Night</span>
						<span class="ellipsis"></span>
					</div>
					<div class="rank-seat">
				      					      						      			<span class="no-schedule">상시 오픈</span>
			...
			<div id="course_2516" class="course col-sm-6 col-md-4 col-lg-3 card ">
	<div class="main-wrapper" >
		
		
		<a href="course/2516.jsp">
	        <div class="image-wrapper" style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/qebqllvu4snwmadyl8e7');">
			...
			<div class="info-wrapper">
				<div class="author-wrapper">
					...
					<h2>[+TAB] BTS - 봄날</h2>
					<div class="summary">
						<span>BTS (방탄소년단) - Spring Day</span>
						<span class="ellipsis"></span>
					</div>
					<div class="rank-seat">
				      					      						      			<span class="no-schedule">상시 오픈</span>
			...
			<div id="course_2531" class="course col-sm-6 col-md-4 col-lg-3 card ">
	<div class="main-wrapper" >
		
		
		<a href="course/2531.jsp">
	        <div class="image-wrapper" style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/vuj85ss1bzefzrntotju');">
			...
			<div id="course_2509" class="course col-sm-6 col-md-4 col-lg-3 card ">
	<div class="main-wrapper" >
		
		
		<a href="course/2509.jsp">
	        <div class="image-wrapper" style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/nmqdpzorgugzfbrdhhqj');">
			...
			<div class="info-wrapper">
				<div class="author-wrapper">
					...
					<h2>[+TAB] Zion.T - 노래</h2>
					<div class="summary">
						<span>Season 3 / N06 / 자이언티 - THE SONG</span>
						<span class="ellipsis"></span>
					</div>
					<div class="rank-seat">
				      					      						      			<span class="no-schedule">상시 오픈</span>
			...
			<div id="course_2548" class="course col-sm-6 col-md-4 col-lg-3 card ">
	<div class="main-wrapper" >
		
		
		<a href="course/2548.jsp">
	        <div class="image-wrapper" style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/ylrcjloqcfoceuaknunj');">
			...
			<div class="info-wrapper">
				<div class="author-wrapper">
					...
					<div class="master-name">카페인기타 </div>
	            	<div class="course-duration">2 개의 강의</div>
					<h2>[+TAB] 로이킴, 김이지 - HEAVEN</h2>
					<div class="summary">
						<span>Roy Kim, Kim E Ji | GGot Jam Project(꽃잠프로젝트) - 헤븐</span>
						<span class="ellipsis"></span>
					</div>
					<div class="rank-seat">
				      					      						      			<span class="no-schedule">상시 오픈</span>
			...
			<div id="course_2503" class="course col-sm-6 col-md-4 col-lg-3 card ">
	<div class="main-wrapper" >
		
		
		<a href="course/2503.jsp">
	        <div class="image-wrapper" style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/qoorwerc7g4gemp3ktwe');">
			...
			<div class="info-wrapper">
				<div class="author-wrapper">
					...
					<div class="master-name">카페인기타 </div>
	            	<div class="course-duration">2 개의 강의</div>
					<h2>[+TAB] 악동뮤지션 - 오랜 날 오랜 밤 </h2>
					<div class="summary">
						<span>AKMU Akdong Musician - Last Goodbye </span>
						<span class="ellipsis"></span>
					</div>
					<div class="rank-seat">
				      					      						      			<span class="no-schedule">상시 오픈</span>
	...
	<div style="display:none">
                    ...
                    <li class="disabled"><span>&laquo;</span></li>
                                                                        ...
                                                                        <li class="active"><span>1</span></li>
                                                                                <li><a href="course31b8.jsp?paging=1&amp;page=2">2</a></li>
                                                                                <li><a href="course057e.jsp?paging=1&amp;page=3">3</a></li>
                                                                                <li><a href="coursee64a.jsp?paging=1&amp;page=4">4</a></li>
                                                                                <li><a href="course8d87.jsp?paging=1&amp;page=5">5</a></li>
                                                                                <li><a href="course4e42.jsp?paging=1&amp;page=6">6</a></li>
                                                                                <li><a href="course43a3.jsp?paging=1&amp;page=7">7</a></li>
                                                                                <li><a href="course9fd6.jsp?paging=1&amp;page=8">8</a></li>
                                                                                <li><a href="course385b.jsp?paging=1&amp;page=9">9</a></li>
                                                                                <li><a href="course5dd5.jsp?paging=1&amp;page=10">10</a></li>
                                                                                <li><a href="course06a0.jsp?paging=1&amp;page=11">11</a></li>
                                                        
        
                    <li><a href="course31b8.jsp?paging=1&amp;page=2" rel="next">&raquo;</a></li>
            </ul>
...
tour.addSteps([
	{
		element: "#guide-tour-course-unpublished",
		placement: "bottom",
		title: "코스 비공개",
		content: "코스를 사용자에게 공개하려면 코스 설정 메뉴에서 공개로 설정해주세요."
	},
	{
		element: "#guide-tour-course-setting",
		placement: "bottom",
		title: "코스 설정하기",
		content: "코스 공개/비공개 여부, 추천 코스, 메인 광고 영역에 노출 등을 설정할 수 있어요."
	},
	{
		element: "#guide-tour-course-arrange",
		placement: "right",
		title: "코스 순서 변경하기",
		content: "코스 카드를 드래그 앤 드롭하여 코스 순서를 변경할 수 있어요.",
...
tour.start();
  ...
  <script type="text/javascript">
    ...
    wcs_do();
		...
		<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"80e91f9934","applicationID":"38309245","transactionName":"YVAGZkZXV0oCBk0NClgaJVFAX1ZXTAZWERdFUEpbWlJcQQ==","queueTime":0,"applicationTime":415,"atts":"TRcFEA5NREQ=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>
