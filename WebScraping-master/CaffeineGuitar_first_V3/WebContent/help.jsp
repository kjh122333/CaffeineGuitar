...
<div class="sub-page-header">
	...
	<div class="image-wrapper cover-image">
		<div class="va-container va-container-h va-container-v text-center">
			<div class="va-middle">
				<h1>고객지원</h1>
			</div>
		</div>
...
<div class="helps-wrapper container">
	<div class="row">
		<div class="col-md-8 col-xs-12">
			<ul class="nav nav-pills">
				<li class="active">
					<a href="#total" data-toggle="tab">전체</a>
				</li>
							</ul>
			<div class="tab-content clearfix">
				<div id="total" class="tab-pane active">
					<div id="accordion_all" class="panel-group">
											</div>
				</div>
							</div>
		</div>
		<div class="col-md-4 col-xs-12">
			...
			<div class="contact-wrapper">
				<div class="header">
					<h4>문의하기</h4>
					<p class="text-muted">문의할 내용이 있으신가요?</p>
				</div>
				<div class="form-wrapper">
					<form method="POST" action="https://guitar.academy-cloud.net/contacts" accept-charset="UTF-8" id="new_contact" class="new_contact"><input name="_token" type="hidden" value="KrlJnFyqXXRMKPsAGy0wX1RuiRilGWxe0pi7Fpr8">
						<div class="form-group">
							<input class="form-control" required="required" placeholder="이메일을 입력하세요" id="contact_email" name="email" type="email" value="">
						</div>
						<div class="form-group">
							<textarea class="form-control" required="required" rows="10" placeholder="문의내용을 입력하세요" id="contact_content" name="content" cols="50"></textarea>
						</div>
						<div class="actions">
							<input class="btn btn-primary va-container-h" type="submit" value="문의하기">
						</div>
					</form>
				</div>
			</div>
  ...
  <script type="text/javascript">
    ...
    wcs_do();
		...
		<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"80e91f9934","applicationID":"38309245","transactionName":"YVAGZkZXV0oCBk0NClgaJVFAX1ZXTA1cCBU=","queueTime":0,"applicationTime":170,"atts":"TRcFEA5NREQ=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>

<!-- Mirrored from guitar.academy-cloud.net/help by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 May 2018 06:10:03 GMT -->
</html>
