...
<head>
	...
	<link rel="icon" type="image/png" href="./build/images/android-icon-192x192-d4e930a755.png"
		sizes="192x192" />
	<!--[if lt IE 9]>
...
(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse"
						...
						<ul class="nav navbar-nav">
							<li><a href="https://guitar.academy-cloud.net/course">코스
									목록</a></li>
							<li><a href="https://guitar.academy-cloud.net/user/lecture">내
									강의실</a></li>
						</ul>
						<ul class="nav navbar-nav navbar-right">
							<li><a class="dropdown-toggle" role="button"
								data-toggle="dropdown" aria-haspopup="true"
								aria-expanded="false" href="#"> <img alt="avatar image"
									class="avatar-image" width="34" height="34"
									src="/build/images/no_avatar-1d6cf41703.jpg"> 이제훈 <span
									class="caret"></span>
							</a>
								<ul class="dropdown-menu">
									<li><a
										href="https://guitar.academy-cloud.net/user/lecture">내 강의실</a></li>
									<li><a href="https://guitar.academy-cloud.net/user/buy">구매내역</a></li>

									<li class><a
										href="https://guitar.academy-cloud.net/user/profile">설정</a></li>
									<li role="separator" class="divider"></li>
									<li><a href="https://guitar.academy-cloud.net/logout"
										data-method="post" rel="nofollow">로그아웃</a></li>
								</ul></li>
						</ul>
					</div>
				</div>
						...
						<div class="col-md-12">
							<div class="registrations-wrapper">
								<table class="table table-hover table-bordered">
									...
									<tr>
										<th>주문번호</th>
										<td>imp_064453325866</td>
									</tr>
									<tr>
										<th>코스명</th>
										<td>[+TAB] 로이킴 - 그때 헤어지면 돼</td>
									</tr>
									<tr>
										<th>결제일</th>
										<td>2018-05-08 11:48:21</td>
									</tr>
									<tr>
										<th>결제금액</th>
										<td>1,900 원</td>
									...
									<tr>
										<th>결제상태</th>
										<td>결제완료 <a	href="https://guitar.academy-cloud.net/buy/request_refund/23110"
											data-remote class="btn btn-default btn-sm">환불요청</a>
										</td>
									</tr>
									<tr>
										<th>영수증</th>
										<td>영수증 출력 <a
											href="https://iniweb.inicis.com/DefaultWebApp/mall/cr/cm/mCmReceipt_head.jsp?noTid=StdpayDBNKMOIacademy20180508114819582088&noMethod=1"
											target="blank" class="btn btn-default btn-sm">영수증 출력하기</a>
										</td>
									</tr>
									</tbody>
								</table>
								<!-- TODO 사라님 여기 icon이 적용이 안되요~ -->
								<a href="javascript:history.back()"><span
									class='fa fa-chevron-left'></span> 구매내역 리스트</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row top-text">
					<ul class="col-md-7 col-sm-12 menu">
						<li class="menu-button"><a target="_blank"
							href="//www.youtube.com/caffeineguitar"> <span
								class="link footer-about_company">회사소개</span>
						</a></li>
						<li class="menu-button"><a href="/terms"> <span
								class="link footer-terms">이용약관</span>
						</a></li>
						<li class="menu-button"><a href="/privacy"> <span
								class="link footer-privacy">개인정보취급방침</span>
						</a></li>
						<li class="menu-button"><a href="/help"> <span
								class="link footer-support">고객지원</span>
						</a></li>
					</ul>
					<div class="col-md-5 col-sm-12 copyright">
						<span class="footer-copyright">본 사이트 내의 콘텐츠는 한국음악저작권협회와의
							저작권 계약 하에 적법하게 서비스 되고 있습니다. 고객상담 카카오톡 ID : 카페인기타 | Copyright ©
				...
				<div class="bottom-text row">
					...
					<div class="col-md-4 col-sm-12 sns-icons">
						<ul class="list-layout list-inline" itemscope=""
							...
							<li><a
								href="//youtube.com/c/CaffeineGuitar?sub_confirmation=1"
				...
				<div class="row selector-wrapper">
					<div class="col-xs-12">
						<div class="powered_by">
							<div class="mt5">본 사이트는 Chrome 브라우저에 최적화 되어 있습니다. 현재 베타
								버전으로 운영되고 있으며, 불편한 사항이나 오류 사항을 피드백 주시면 개선해 나가도록 하겠습니다.</div>
						</div>
					</div>
				</div>
			</div>
	...
	<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"80e91f9934","applicationID":"38309245","transactionName":"YVAGZkZXV0oCBk0NClgaJVFAX1ZXTBBKARdpVxFLR15WTg==","queueTime":0,"applicationTime":333,"atts":"TRcFEA5NREQ=","errorBeacon":"bam.nr-data.net","agent":""}
	</script>
