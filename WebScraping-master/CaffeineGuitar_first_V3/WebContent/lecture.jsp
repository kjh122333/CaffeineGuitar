...
<meta name="csrf-token"
	content="g91TDvQMHL867mvJEBHEgGNpaSiVyieaAhnRFrtt">
...
<link rel="icon" type="image/png"
	href="/build/images/android-icon-192x192-d4e930a755.png"
	sizes="192x192" />
<!--[if lt IE 9]>
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div class="wrapper">
		<header class="main-header">
			<nav class="navbar navbar-default navbar-fixed-top bg">
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-bit-academy-navbar-collapse">
						<ul class="nav navbar-nav">
							<li><a href="course.jsp">코스 목록</a></li>
							<li class="active"><a href="lecture.jsp">내 강의실</a></li>
						</ul>
						<ul class="nav navbar-nav navbar-right">
							<li><a href="#" class="dropdown-toggle" role="button"
								data-toggle="dropdown" aria-haspopup="true"
								aria-expanded="false"> <img alt="avatar image"
									...
									<li><a href="buy.jsp">구매내역</a></li>

									<li><a href="profile.jsp">설정</a></li>
									<li role="separator" class="divider"></li>
									<li><a href="index_략.jsp" data-method="post" rel="nofollow">로그아웃</a></li>
								</ul>
		...
		<div class="main-wrapper">
			...
			<div class="mypage-wrapper" style="margin-bottom: 0;">
				<div class="container mt15">
					<div class="row">
						...
						<div class="course-list" data-behavior="endless-scroll">
							<div id="course_4556"
								class="course col-sm-6 col-md-4 col-lg-3 card ">
								<div class="main-wrapper">


									<a href="https://guitar.academy-cloud.net/course/overview/4556">
	...
	<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"80e91f9934","applicationID":"38309245","transactionName":"YVAGZkZXV0oCBk0NClgaJVFAX1ZXTBBKARdpWQFRQENLXA==","queueTime":0,"applicationTime":290,"atts":"TRcFEA5NREQ=","errorBeacon":"bam.nr-data.net","agent":""}</script>
</body>
</html>
