...
<meta property="og:description"
	content="유튜버 카페인기타, 최신곡 기타 타브악보, 기타 독학 강좌, 기타 커버, 기타 악보" />
<meta property="og:url" content="http://guitar.academy-cloud.net" />
<meta property="og:image"
	content="http://res.cloudinary.com/clebee/image/upload/eulrodk25s5gzxzdnwzh" />
...
(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div class="overlay" id="signup-modal" role="dialog" tabindex="-1"
		aria-labelledby="signup-modal" data-behavior="backdrop">
		<div class="modal-table">
			<div class="modal-cell">
				<div class="modal-content">
					<button type="button" class="modal-close-outside"
						data-behavior="modal-close" aria-label="닫기"></button>
					...
					<div class="modal-body">
						<div class="signup signup-and-in-form">
							...
							<form method="POST"
								action="https://guitar.academy-cloud.net/register"
								accept-charset="UTF-8" class="new_user" id="new_user">
								<input name="_token" type="hidden"
									value="KrlJnFyqXXRMKPsAGy0wX1RuiRilGWxe0pi7Fpr8"> <input
									name="_token" type="hidden"
									value="KrlJnFyqXXRMKPsAGy0wX1RuiRilGWxe0pi7Fpr8">
								<div class="form-group">
									<input class="form-control" autofocus="autofocus"
										placeholder="닉네임" required="required" id="user_name"
										name="name" type="text" value="">
								</div>
								<div class="form-group">
									<input class="form-control" placeholder="이메일"
										required="required" id="user_email" name="email" type="email">
								</div>
								<div class="form-group">
									<input class="form-control" autocomplete="off"
										placeholder="비밀번호 (적어도 6자 이상 입력)" required="required"
										id="user_password" name="password" type="password" value="">
								</div>
								<div class="form-group">
									<input class="form-control" autocomplete="off"
										placeholder="비밀번호 확인" required="required"
										id="user_password_confirmation" name="password_confirmation"
										type="password" value="">
								</div>
						...
						<div class="signup-wrapper">
							<span class="text-muted">이미 계정이 있으신가요?</span> <a
								href="javascript_%20void(0)%3b.jsp" class="text-primary"
								data-behavior="trigger-signup-signin">로그인</a>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="overlay" id="signin-modal" role="dialog" tabindex="-1"
		aria-labelledby="signin-modal" data-behavior="backdrop">
		<div class="modal-table">
			<div class="modal-cell">
				<div class="modal-content">
					<button type="button" class="modal-close-outside"
					...
					<div class="modal-body">
						<div class="signin signup-and-in-form">
							<img src="images/logo-academy.png" class="logo img-responsive">
							<form method="POST"
								action="https://guitar.academy-cloud.net/login"
								...
								<div class="form-group">
									<input class="form-control" autofocus="autofocus"
										placeholder="이메일" title="이메일 주소" required="true" id="email"
										name="email" type="email"> <input class="form-control"
										autocomplete="off" placeholder="비밀번호 (적어도 6자 이상 입력)"
										title="비밀번호 (적어도 6자 이상 입력)" required="true" id="password"
								...
								<div class="form-group mt20 mb30">
									...
									<div class="remember_me">
										<input id="remember" class="with-font" name="remember"
											type="checkbox" value="1"> <label for="remember">로그인
											기억하기</label>
									</div>
								</div>
						...
						<div class="signup-wrapper">
							<span class="text-muted">아직 계정이 없으신가요?</span> <a
								href="register.jsp" class="text-primary"
								data-behavior="trigger-signin-signup">회원가입</a>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="wrapper">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="javascript://void(0);"
						data-behavior="trigger-signin">로그인</a></li>
					<li><a href="javascript://void(0);"
						data-behavior="trigger-signup">회원가입</a></li>
				</ul>
			</div>
		</div>
		</nav> </header>
		<div class="main-wrapper">
			...
			<div class="hero">
				<div class="hero-background background-cover"
					style="background-image: url(http://res.cloudinary.com/clebee/image/upload/eulrodk25s5gzxzdnwzh) !important;"></div>
						...
						<div class="va-middle">
							<div class="container">
								...
								<h4 class="text-inverse">
									<div class="hero-sub">유튜버 카페인기타, 최신곡 기타 타브악보, 기타 독학 강좌,
										기타 커버, 기타 악보</div>
								</h4>
							</div>
						</div>
				...
				<div class="hero-footer">
					<div class="container">
						<div class="col-md-6 col-md-offset-3">
							<form method="GET"
								action="https://guitar.academy-cloud.net/search"
								accept-charset="UTF-8">
								<div class="form-group">
									<label class="sr-only" for="lectureSearch">강의 검색</label>
									<div class="input-group">
										<input type="text" class="form-control input-lg"
											name="keyword" value="" placeholder="배우고 싶은 강의를 검색하세요.">
			...
			<div class="container">
				...
				<div class="editor-choices-courses-list">
					<div class="row">
						<div id="course_2627"
							class="course col-sm-6 col-md-4 col-lg-3 card ">
							<div class="main-wrapper">


								<a href="course/2627.jsp">
									<div class="image-wrapper"
										style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/zlxt41fedrvmvwyrngza');">
										...
										<div class="author-wrapper">
											<div class="author-image-wrapper">
												<div class="img-ew img-small">
													<img
														src="http://res.cloudinary.com/clebee/image/upload/c_thumb,h_40,w_40/sry895mavvbtfsgr23vy"
														class="avatar-image" width="40" height="40"
														alt="avatar image">
												</div>
											</div>
											...
											<h2>카페인기타 통기타 입문</h2>
											<div class="summary">
												<span>기타를 배우고 싶은 분들을 위한 온라인 레슨</span> <span class="ellipsis"></span>
											</div>
											<div class="rank-seat">
												<span class="no-schedule">상시 오픈</span>
												<div class="remain-seat">
													<span class="current"> 49,000 원 </span>
												</div>
											</div>
										</div>
									</div>
						...
						<div id="course_2561"
							...
							<div class="main-wrapper">
								...
								<a href="course/2561.jsp">
									<div class="image-wrapper"
										style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/iva3uqtufrz42cw37b4j');">
									...
									<div class="info-wrapper">
										<div class="author-wrapper">
											...
											<div class="summary">
												<span>카페인기타의 아이유 커버곡 악보 모음집입니다.</span> <span
													class="ellipsis"></span>
											</div>
											<div class="rank-seat">
												<span class="no-schedule">상시 오픈</span>
												<div class="remain-seat">
													<span class="current"> 9,900 원 </span>
												</div>
											</div>
										</div>
									</div>
						...
						<div id="course_2544"
							...
							<div class="main-wrapper">
								...
								<a href="course/2544.jsp">
									<div class="image-wrapper"
										style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/c7ixzvayrdxp9rpff7ln');">
									...
									<div class="info-wrapper">
										<div class="author-wrapper">
											...
											<div class="summary">
												<span>카페인기타의 볼빨간사춘기 커버곡 악보 모음집입니다.</span> <span
													class="ellipsis"></span>
											</div>
											<div class="rank-seat">
												<span class="no-schedule">상시 오픈</span>
												<div class="remain-seat">
													<span class="current"> 5,500 원 </span>
												</div>
											</div>
										</div>
									</div>
						...
						<div id="course_2517"
							...
							<div class="main-wrapper">
								...
								<a href="course/2517.jsp">
									<div class="image-wrapper"
										style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/gdk82ugsfemxlbqpu91x');">
									...
									<div class="info-wrapper">
										<div class="author-wrapper">
											...
											<h2>10CM - TAB 악보집</h2>
											<div class="summary">
												<span>카페인기타의 10CM 커버곡 악보 모음집입니다.</span> <span
													class="ellipsis"></span>
											</div>
											<div class="rank-seat">
												<span class="no-schedule">상시 오픈</span>
												<div class="remain-seat">
													<span class="current"> 7,700 원 </span>
												</div>
											</div>
										</div>
									</div>
						...
						<div id="course_2640"
							...
							<div class="main-wrapper">
								...
								<a href="course/2640.jsp">
									<div class="image-wrapper"
										style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/khanyxvzi44lmocclgav');">
										<div class="item-label">1 자리 남음</div>
									...
									<div class="info-wrapper">
										<div class="author-wrapper">
											...
											<h2>후원을 해 주세요 :)</h2>
											<div class="summary">
												<span>원하는 곡의 악보와 연주 영상 그리고 어쿠스틱 버전 MR 을 만들어 드립니다.</span> <span
													class="ellipsis"></span>
											</div>
											<div class="rank-seat">
												<span class="no-schedule">상시 오픈</span>
												<div class="remain-seat">
													<span class="current"> 100,000 원 </span>
												</div>
											</div>
										</div>
									</div>
						...
						<div id="course_4006"
							...
							<div class="main-wrapper">
								...
								<a href="course/4006.jsp">
									<div class="image-wrapper"
										style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/0fa67a830c279ff5397abcd8ef695cd4');">
									...
									<div class="info-wrapper">
										<div class="author-wrapper">
											...
											<h2>[+TAB] 로꼬&amp;화사 - 주지마</h2>
											<div class="summary">
												<span>Don&#039;t Give It To Me - Loco &amp; Hwasa</span> <span
													class="ellipsis"></span>
											</div>
											<div class="rank-seat">
												<span class="no-schedule">상시 오픈</span>
												<div class="remain-seat">
													<span class="current"> 1,900 원 </span>
												</div>
											</div>
										</div>
									</div>
						...
						<div id="course_4556"
							...
							<div class="main-wrapper">
								...
								<a href="course/4556.jsp">
									<div class="image-wrapper"
										style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/cf2c9517ef419dbcf758055ebe4aef6c');">
									...
									<div class="info-wrapper">
										<div class="author-wrapper">
											...
											<div class="summary">
												<span>Roy Kim - Only Then</span> <span class="ellipsis"></span>
											</div>
											<div class="rank-seat">
												<span class="no-schedule">상시 오픈</span>
												<div class="remain-seat">
						...
						<div id="course_4517"
							...
							<div class="main-wrapper">
								...
								<a href="course/4517.jsp">
									<div class="image-wrapper"
										style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/b6cec302e510f9f4e9e6ae93edc4fd8f');">
									...
									<div class="info-wrapper">
										<div class="author-wrapper">
											...
											<div class="summary">
												<span>TWICE - What is Love?</span> <span class="ellipsis"></span>
											</div>
											<div class="rank-seat">
												<span class="no-schedule">상시 오픈</span>
												<div class="remain-seat">
						...
						<div id="course_2508"
							...
							<div class="main-wrapper">
								...
								<a href="course/2508.jsp">
									<div class="image-wrapper"
										style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/sdnckzhnfzm5xzvtnglc');">
									...
									<div class="info-wrapper">
										<div class="author-wrapper">
											...
											<div class="summary">
												<span>Bolbbalgan4 - 썸탈꺼야</span> <span class="ellipsis"></span>
											</div>
											<div class="rank-seat">
												<span class="no-schedule">상시 오픈</span>
												<div class="remain-seat">
  ...
  $(document).on("click", ".popover .close" , function(){
	...
	<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"80e91f9934","applicationID":"38309245","transactionName":"YVAGZkZXV0oCBk0NClgaJVFAX1ZXTA1WCQAYXQtfUQ==","queueTime":0,"applicationTime":610,"atts":"TRcFEA5NREQ=","errorBeacon":"bam.nr-data.net","agent":""}</script>
</body>
