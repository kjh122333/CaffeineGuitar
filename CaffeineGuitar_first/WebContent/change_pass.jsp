    ...
    <div class="collapse navbar-collapse" id="bs-cloud-academy-navbar-collapse">
          ...
          <li>
            ...
            <ul class="dropdown-menu">
            	<li><a href="lecture.jsp">내 강의실</a></li>
...
<div class="mypage-wrapper">
  ...
  <a href="https://guitar.academy-cloud.net/user/profile" class="btn btn-default">프로필 설정</a>
  <a href="https://guitar.academy-cloud.net/user/account" class="btn btn-default">계정 정보</a>
  <a href="https://guitar.academy-cloud.net/user/change_pass" class="btn btn-default active">비밀번호 변경</a>
  <!--  -->
</div>  </div>

  <!-- 비밀번호 변경 -->
  <div class="account-wrapper">
  <form method="POST" action="https://guitar.academy-cloud.net/user/cahnge_pass" accept-charset="UTF-8" class="edit_user"><input name="_method" type="hidden" value="PUT"><input name="_token" type="hidden" value="g91TDvQMHL867mvJEBHEgGNpaSiVyieaAhnRFrtt">
  <input type="hidden" name="_token" value="g91TDvQMHL867mvJEBHEgGNpaSiVyieaAhnRFrtt">

      <div class="form-horizontal">
	    <div class="form-group">
	      <label for="current_password" class="col-sm-4 control-label" id="password_form">현재 비밀번호</label>
	      <input name="pick" type="hidden" value="password_form">
          <div class="col-sm-8">
	      <input class="form-control" autofocus autocomplete="off" name="current_password" type="password" value="" id="current_password">
                      </div>
        </div>
	    ...
	    <div class="form-group">
          ...
          <div class="col-sm-8">
	      <input class="form-control" aria-describedby="inputError1Status" autocomplete="off" name="password" type="password" value="" id="password">
            <p class="form-message">대소문자, 숫자, 특수문자 구분없이 최소 6자 이상 입력할 수 있습니다. </p>
                      </div>
        </div>

	    <div class="form-group">
      	 <label for="password_confirmation" class="col-sm-4 control-label">비밀번호 확인</label>
          <div class="col-sm-8">
	      <input class="form-control" autocomplete="off" name="password_confirmation" type="password" value="" id="password_confirmation">
            <p class="form-message">비밀번호 확인을 위해 다시 한 번 입력해주세요.</p>
          </div>
        </div>
        ...
        <div class="actions">
          <div class="form-group">
            <div class="col-sm-offset-4 col-sm-8">
		      <input class="btn btn-success" type="submit" value="비밀번호 변경">
            </div>
          </div>
        </div>
      </div>
  ...
  <script type="text/javascript">
    ...
    wcs_do();
		...
		<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"80e91f9934","applicationID":"38309245","transactionName":"YVAGZkZXV0oCBk0NClgaJVFAX1ZXTBBKARdpVgxTWlFcZhMEShc=","queueTime":0,"applicationTime":177,"atts":"TRcFEA5NREQ=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>
