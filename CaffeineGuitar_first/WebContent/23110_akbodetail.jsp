...
<noscript>
          ...
          <table class="table table-hover table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  결제완료
                                                                        <a href="https://guitar.academy-cloud.net/buy/request_refund/23110" data-remote class="btn btn-default btn-sm">환불요청</a>
                                                              </td>
              </tr>
                              <tr>
                  <th>영수증</th>
                  <td>
                    영수증 출력
                    <a href="https://iniweb.inicis.com/DefaultWebApp/mall/cr/cm/mCmReceipt_head.jsp?noTid=StdpayDBNKMOIacademy20180508114819582088&noMethod=1" target="blank" class="btn btn-default btn-sm">영수증 출력하기</a>
                  </td>
                </tr>
                          </tbody>
          </table>
          <!-- TODO 사라님 여기 icon이 적용이 안되요~ -->
          <a href="https://guitar.academy-cloud.net/user/buy" class= "btn btn-default btn-sm"><span class='fa fa-chevron-left'></span> 구매내역 리스트</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <script type="text/javascript">
    ...
    wcs_do();
		...
		<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"80e91f9934","applicationID":"38309245","transactionName":"YVAGZkZXV0oCBk0NClgaJVFAX1ZXTBBKARdpVxFLR15WTg==","queueTime":0,"applicationTime":333,"atts":"TRcFEA5NREQ=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>
