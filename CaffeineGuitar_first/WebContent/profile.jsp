...
<div class="mypage-wrapper">
  ...
  <a href="https://guitar.academy-cloud.net/user/profile" class="btn btn-default active">프로필 설정</a>
  <a href="https://guitar.academy-cloud.net/user/account" class="btn btn-default">계정 정보</a>
  <a href="https://guitar.academy-cloud.net/user/change_pass" class="btn btn-default">비밀번호 변경</a>
  <!--  -->
</div>  </div>

  <!-- 프로필 설정 -->
  <div class="account-wrapper">
    <form method="POST" action="https://guitar.academy-cloud.net/user" accept-charset="UTF-8" data-remote id="profile"><input name="_method" type="hidden" value="PATCH"><input name="_token" type="hidden" value="g91TDvQMHL867mvJEBHEgGNpaSiVyieaAhnRFrtt">
      <input name="pick" type="hidden" value="profile">
      <div class="form-horizontal">
        <div class="form-group">
          <label for="avatar" class="col-sm-4 control-label">프로필 사진</label> 
          <div class="col-sm-8">
            <div class="avatar avatar-lg">
              <img src="//res.cloudinary.com/clebee/image/upload/v1474853884/no_avatar_lelx5b.jpg" class="avatar-img" id="avatar-img">
              <a href= "javascript: void(0);" onclick="$('#avatarupload').click();">
                <div class="avatar-icon" id="profile-avatar-icon">
                  <i class="fa fa-camera"></i>
                </div>
              </a>
              <input id="avatarupload" type="file" name="avatar" data-url="/user/upload/20801" style="display:none;" accept="image/jpeg,image/png,image/gif">
            </div>
          </div>
        </div>
        <div class="form-group">
          <label for="name" class="col-sm-4 control-label">닉네임</label>
          <div class="col-sm-8">
            <input class="form-control" autofocus required="required" name="name" type="text" value="이제훈" id="name">
            <p class="form-message">사이트내 활동시 이름 대신 노출됩니다.</p>
          </div>
        </div>
        ...
        <div class="actions">
          <div class="form-group">
            <div class="col-sm-offset-4 col-sm-8">
              <input class="btn btn-success" id="profile_update" type="submit" value="변경사항 저장">
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="account-wrapper">
    <form method="POST" action="https://guitar.academy-cloud.net/user" accept-charset="UTF-8" data-remote id="about"><input name="_method" type="hidden" value="PATCH"><input name="_token" type="hidden" value="g91TDvQMHL867mvJEBHEgGNpaSiVyieaAhnRFrtt">
      <input name="pick" type="hidden" value="about">
      <div class="form-horizontal">
        <div class="form-group">
          <label for="about" class="col-sm-4 control-label">직업군 및 경력연차</label>
          <div class="col-sm-8">
            <input class="form-control" placeholder="예) 웹디자이너 4년차" name="about" type="text" value="" id="about">
          </div>
        </div>

        <div class="form-group">
          <label for="description" class="col-sm-4 control-label">자기소개</label>
          <div class="col-sm-8">
            <textarea rows="3" placeholder="상세 경력 및 한 줄 소개를 입력해 주세요." class="form-control" name="description" cols="50" id="description"></textarea>
          </div>
        </div>
        <div class="actions">
          <div class="form-group">
...
Profile.avatarUpload("1990");
  ...
  <script type="text/javascript">
    ...
    wcs_do();
		...
		<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"80e91f9934","applicationID":"38309245","transactionName":"YVAGZkZXV0oCBk0NClgaJVFAX1ZXTBBKARdpRRZdUl9VXA==","queueTime":0,"applicationTime":291,"atts":"TRcFEA5NREQ=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>
