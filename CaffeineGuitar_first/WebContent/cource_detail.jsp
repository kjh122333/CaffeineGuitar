...
<head>
	...
	<meta property="og:title" content="박효신 - 별 시" />
	<meta property="og:description" content="The Other Day -  Park Hyo Shin" />
	<meta property="og:url" content="https://guitar.academy-cloud.net/courses/166" />
	<meta property="og:image" content="http://res.cloudinary.com/clebee/image/upload/c0f0df2742065b40c5276ef813cdae10" />
	<meta property="og:site_name" content="아카데미 클라우드" />
	<meta property="og:type" content="website" />
	<meta name="twitter:title" content="박효신 - 별 시" />
	<meta name="twitter:description" content="The Other Day -  Park Hyo Shin" />
	<meta name="twitter:url" content="https://guitar.academy-cloud.net/courses/166" />
	<meta name="twitter:image" content="http://res.cloudinary.com/clebee/image/upload/c0f0df2742065b40c5276ef813cdae10" />
	...
	<meta name="csrf-token" content="g91TDvQMHL867mvJEBHEgGNpaSiVyieaAhnRFrtt">
...
<noscript>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-cloud-academy-navbar-collapse">
          ...
          <li>
            <a href="https://guitar.academy-cloud.net/course">코스 목록</a>
          </li>
          <li>
          	<a href="https://guitar.academy-cloud.net/user/lecture">내 강의실</a>
          </li>
        </ul>
            <ul class="nav navbar-nav navbar-right">
		                  <li>
          	<a class="dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">
          		<img alt="avatar image" class="avatar-image" width="34" height="34" src="/build/images/no_avatar-1d6cf41703.jpg">
          		이제훈
          		<span class="caret"></span>
          	</a>
            <ul class="dropdown-menu">
            	<li><a href="https://guitar.academy-cloud.net/user/lecture">내 강의실</a></li>
            	<li><a href="https://guitar.academy-cloud.net/user/buy">구매내역</a></li>
            
              	<li class>
                	<a href="https://guitar.academy-cloud.net/user/profile">설정</a>
              	</li>
              <li role="separator" class="divider"></li>
              <li>
                <a href="https://guitar.academy-cloud.net/logout" data-method="post" rel="nofollow">로그아웃</a>
              </li>
            </ul>
          </li>
              </ul>
...
<div class="course-wrapper">
	<div class="course-header container">
		<div class="row">
			<div class="col-md-8 col-sm-12 course-image-container">
            <div class="course-image" style="background-image: url('http://res.cloudinary.com/clebee/image/upload/c_fill,h_460,w_765/c0f0df2742065b40c5276ef813cdae10');"></div>
    </div>
<div class="col-md-4 col-sm-12 course-info-container">
        
        <div class="course-info">
            <h1>박효신 - 별 시</h1>
            <h2>The Other Day -  Park Hyo Shin</h2>
            <span class="course-price">
                                    1,900 원
                            </span>
            <ul class="course-date">
                <li>
                                            수강 기간 <span>30 일</span>
                                    </li>
                <li>
                                            모집 인원 <span>제한 없음</span>
                                    </li>
            </ul>
    
            <div class="header-action-buttons">
                                                            								                            <a href="https://guitar.academy-cloud.net/check_user/2499" class="btn btn-primary" data-remote="true">수강 신청</a>
                                                                                                    </div>
...
<div id="is_alert_course_name" style="display:none"></div>
		</div>
	</div>
	...
	<div class="course-body">
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-sm-12 course-detail-container">
											<div class="content-block course-summary">
							<h2 class="pull-left">코스소개</h2>
<p class="pull-right">&nbsp;</p>
<div class="summary">
  <dl class="dl-horizontal">
    <dt>목표</dt>
    <dd>타브악보를 활용해 개별 곡 연주를 할 수 있습니다.</dd>
  </dl>
  <dl class="dl-horizontal">
    <dt>대상</dt>
    <dd>개별곡 연습을 위한 악보가 필요하신 분</dd>
  </dl>
  <dl class="dl-horizontal">
    <dt class="extra-txt">난이도</dt>
    <dd>중급</dd>
  </dl>
</div>
						</div>
							...
							<h2 class="pull-left">코스상세 정보</h2>
<p class="pull-right">&nbsp;</p>
<div  class="course-content border-top">
  <img src="https://d2z6n5z8o9zhav.cloudfront.net/guitar/uploads/ab8f78d4f789405c44f51dca708d92f2/guitar-c158.png" style="max-width: 100%; height: auto; color: rgb(60, 72, 88); width: 728px;">
</div>
						</div>
					
					<div class="comment-container">
						<div class="fb-comments" data-width="100%" data-href="https://guitar.academy-cloud.net/courses/166" data-numposts="5"></div>
					</div>
				</div>

				<div class="col-md-4 col-sm-12 course-aside-container">
					<div class="content-block course-curriculum">
  						<h2 class="pull-left">강의목록</h2>
<p class="curriculum-count pull-right">총 1 회차</p>
<div class="curriculums block-sortable" data-update-url="https://guitar.academy-cloud.net/course/2499/section/sort">
    	<div id="section_3398" class="section">
			<div class="section-name">
			<span class="section-title">박효신 - 별 시</span>
	    </div>
		
	<ul class="item-sortable" data-update-url="https://guitar.academy-cloud.net/section/3398/lecture/sort">
					<input type='hidden' value='null'>

<li id="lecture_9614" class="lecture ">
  <a href="https://guitar.academy-cloud.net/classroom/2499/9614">
    <span class="lecture-type">
                    <i class='fa fa-file-text-o'></i>
          </span>
    <span class="lecture-title" >박효신 - 별 시</span>
					...
					<div class="content-block">
						<h2 class="pull-left">소셜공유</h2>
<p class="pull-right">
    	이 코스를 알려주세요
  </p>

<div class="social-buttons border-top">
  <div class="social-button twitter pull-left">
    <a href="//twitter.com/share" class="twitter-share-button">Tweet</a>
  </div>
  <div class="social-button facebook">
    <div class="fb-share-button" data-href='https://guitar.academy-cloud.net/courses/166' data-layout="button_count"></div>
  </div>
</div>
					</div>

											<div class="content-block border-color-top">
							<div class="master">
    <div class="master-card">
      <div class="avatar-with-label">
        <img src="http://res.cloudinary.com/clebee/image/upload/sry895mavvbtfsgr23vy" class="avatar-image" width="70" height="70" alt="avatar image">
        <span class="label label-primary">코스마스터</span>
      </div>
      <span class="username">카페인기타 </span>
      <p>Guitarist</p>
...
<script type="text/javascript">
  ...
  var tour = new Tour({
    ...
    steps: [
    {
      ...
      placement: "bottom",
      title: "영역별 편집하기",
      content: "영역별로 표시된 연필 아이콘을 눌러 코스 정보를 작성하세요."
    },
    {
      element: "#guide-tour-lecture-move",
      placement: "bottom",
      title: "섹션, 강의 순서 변경하기",
      content: "아이콘을 드래그 앤 드롭하여 섹션, 강의 순서를 변경할 수 있어요."
    },
    {
      element: "#guide-tour-lecture-title",
      placement: "bottom",
      title: "강의 편집하기",
      content: "동영상 강의, 문서 강의를 등록할 수 있어요."
    },
    {
      element: "#guide-tour-media-console",
      placement: "top",
      title: "미디어 관리",
      content: "강의에 사용할 동영상, 이미지 파일을 업로드하세요.",
  ...
  <div class="row top-text">
    <ul class="col-md-7 col-sm-12 menu">
          ...
          <a target="_blank" href="//www.youtube.com/caffeineguitar">
    ...
    <div class="col-md-8 col-sm-12 company_info">
      ...
      <div class="address">
        ...
        <ul class="list-layout list-inline" itemscope="" itemtype="http://schema.org/Organization">
                      ...
                      <li>
              <a href="//youtube.com/c/CaffeineGuitar?sub_confirmation=1" class="link-contrast footer-icon-container" target="_blank">
  ...
  <script type="text/javascript">
    ...
    wcs_do();
		...
		<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"80e91f9934","applicationID":"38309245","transactionName":"YVAGZkZXV0oCBk0NClgaJVFAX1ZXTAZWERdFUEpBXFlO","queueTime":0,"applicationTime":253,"atts":"TRcFEA5NREQ=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>
