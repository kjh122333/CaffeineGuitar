...
(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div class="wrapper">
		...
		<div class="main-wrapper">
			<div class="flash-container">
				<div class="flash-alert alert alert-warning" role="alert">
					이용하시려면 로그인하거나 가입하셔야 합니다.
			...
			<div class="container">
				<div class="page-wrap">
					<form method="POST" action="https://guitar.academy-cloud.net/login"
						...
						<div class="form-group">
							<label for="email">이메일</label> <input id="email"
								class="form-control" autofocus required name="email"
								type="email">
						</div>
						<div class="form-group">
						...
						<div class="form-group mt20 mb30">
							<div class="forget-password">
								<a href="password/reset.jsp">비밀번호를 잊어버렸나요?</a>
							</div>
				...
				<div class="signup-wrapper">
					<span class="text-muted">아직 계정이 없으신가요?</span> <a
						href="register.jsp" class="text-primary">회원가입</a>
				</div>
			</div>
	...
	<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"80e91f9934","applicationID":"38309245","transactionName":"YVAGZkZXV0oCBk0NClgaJVFAX1ZXTAlWAwxY","queueTime":0,"applicationTime":182,"atts":"TRcFEA5NREQ=","errorBeacon":"bam.nr-data.net","agent":""}</script>
</body>

<!-- Mirrored from guitar.academy-cloud.net/login by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 May 2018 06:09:47 GMT -->
