...
<div class="mypage-wrapper">
  ...
  <a href="https://guitar.academy-cloud.net/user/account" class="btn btn-default active">계정 정보</a>
  <a href="https://guitar.academy-cloud.net/user/change_pass" class="btn btn-default">비밀번호 변경</a>
  <!--  -->
</div>  </div>

  <div class="account-wrapper">
    <form method="POST" action="https://guitar.academy-cloud.net/user" accept-charset="UTF-8" data-remote id="account"><input name="_method" type="hidden" value="PATCH"><input name="_token" type="hidden" value="g91TDvQMHL867mvJEBHEgGNpaSiVyieaAhnRFrtt">
      <input name="pick" type="hidden" value="account">
      <div class="form-horizontal">
        <div class="form-group">
          <label for="email" class="col-sm-4 control-label">이메일</label>
          <div class="col-sm-8">
            <input class="form-control" disabled name="email" type="email" value="zack_@naver.com" id="email">
                      </div>
        </div>

        <div class="form-group">
          <label for="realname" class="col-sm-4 control-label">실명</label>
          <div class="col-sm-8">
            <input class="form-control" name="realname" type="text" value="이제훈" id="realname">
            <p class="form-message">수료증 출력 등 필요한 경우에만 사용됩니다.</p>
          </div>
        </div>

        <div class="form-group">
          <label for="contact" class="col-sm-4 control-label">연락 가능한 이메일</label>
          <div class="col-sm-8">
            <input class="form-control" name="contact" type="text" value="zack_@naver.com" id="contact">
            <p class="form-message">자주 사용하는 연락 가능한 이메일</p>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input class="form-control" name="tel" type="text" value="010-3005-3915" id="tel">
          </div>
        </div>
        ...
        <div class="actions">
          <div class="form-group">
            <div class="col-sm-offset-4 col-sm-8">
              <input class="btn btn-success" type="submit" value="변경사항 저장">
            </div>
          </div>
        </div>
      </div>
  ...
  <script type="text/javascript">
    ...
    wcs_do();
		...
		<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"80e91f9934","applicationID":"38309245","transactionName":"YVAGZkZXV0oCBk0NClgaJVFAX1ZXTBBKARdpVAdRW0NXTQ==","queueTime":0,"applicationTime":176,"atts":"TRcFEA5NREQ=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>
